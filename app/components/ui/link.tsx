...
export const LinkComponentButtonBlue = ({
  className,
  children,
  ...props
}: LinkComponentProps) => {
  return (
    <LinkComponent
      className={`!border-blue-700 !bg-blue-700 px-3 py-2 !text-white/90 hover:!border-blue-800 hover:!bg-blue-800 dark:!border-blue-800 dark:!bg-blue-800 dark:hover:!border-blue-700 dark:hover:!bg-blue-700 ${
        className || ""
      }`}
      {...props}
    >
